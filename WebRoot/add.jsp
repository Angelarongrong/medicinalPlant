...
<html>
  ...
  <body>
   ...
   <!-- 添加药用植物界面开始 -->
	    ...
	    <div class="row">
		   <div class="col-md-12">
		      <s:form action="plant/plant_addPlant" cssClass="form-horizontal" enctype="multipart/form-data">
		       <div class="panel panel-success">
			       <div class="panel-heading">
		               <h4 class="panel-title"> 添 加 植 物  </h4>
		           </div>
		           <div class="panel-body">
				       <div class="form-group">
			                <label class="control-label col-md-3">学名  (Scientific name)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.scname" class="form-control input-sm" value="尚未填写学名" required>
                           </div>
			           </div>  
			           <div class="form-group">
			                <label class="control-label col-md-3">学名  (中文名)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.scchname" class="form-control input-sm" value="尚未填写学名(中文名)" required>
                           </div>
			           </div>  
			           <div class="form-group">
			                <label class="control-label col-md-3">俗名  (Local name)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.loname" class="form-control input-sm" value="尚未填写俗名" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">俗名  (中文)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.chloname" class="form-control input-sm" value="尚未填写俗名（中文名）" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">科  (Family name)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.faname" class="form-control input-sm" value="尚未填写科"  required>
                            </div>
			           </div>
			            <div class="form-group">
			                <label class="control-label col-md-3">科  (中文名)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.chfaname" class="form-control input-sm" value="尚未填写科  (中文名)" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">属  (Genera)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.genera" class="form-control input-sm" value="尚未填写属  " required>
                            </div>
			           </div>
			            <div class="form-group">
			                <label class="control-label col-md-3">属  (中文名)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.chgenara" class="form-control input-sm" value="尚未填写属  (中文名)" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">用途  (Purpose)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.purpose" class="form-control input-sm" value="尚未填写用途" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">用法  (Usgae)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.pusage" class="form-control input-sm" value="尚未填写用法" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">药用部位  (Part used)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.partused" class="form-control input-sm" value="尚未填写药用部位" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">编号  (Voucher Number)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.vnumber" class="form-control input-sm" value="尚未填写编号" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">RI值  (RI value)</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.rivalue" class="form-control input-sm" value="0" required>
                            </div>
			           </div>
			           <div class="form-group">
			                <label class="control-label col-md-3">备注</label>
			                <div class="col-md-8">
                              <input type="text" name="plant.remarks" class="form-control input-sm" value="尚未填写备注" required>
                            </div>
			           </div>
			           <div class="form-group">
			                ...
			                <div class="col-md-4">
                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div>
                                   ...
                                   <span class="fileupload-exists">浏览</span><input type="file" name="plantPhoto"/></span>
			           ...
			           <div class="form-group col-md-3">
				          <button type="submit" class="btn btn-success pull-right">添  加 </button>
				       </div>
				   </div>
				</div>
		    </s:form>
